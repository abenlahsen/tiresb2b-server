...
final class Version20200811134927 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS blog_post (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, creator_id INT NOT NULL, content LONGTEXT NOT NULL, slug VARCHAR(255) NOT NULL, titre VARCHAR(255) NOT NULL, blog_image VARCHAR(255) NOT NULL, plubished_at DATETIME DEFAULT NULL, deleted TINYINT(1) NOT NULL, valid TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_BA5AE01D989D9B62 (slug), UNIQUE INDEX UNIQ_BA5AE01DFF7747B4 (titre), INDEX IDX_BA5AE01DF675F31B (author_id), INDEX IDX_BA5AE01D61220EA6 (creator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS blog_post_categorie (blog_post_id INT NOT NULL, categorie_id INT NOT NULL, INDEX IDX_AC64037AA77FBEAF (blog_post_id), INDEX IDX_AC64037ABCF5E72D (categorie_id), PRIMARY KEY(blog_post_id, categorie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS historique (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, blog_post_id INT NOT NULL, old_post_id INT DEFAULT NULL, action VARCHAR(255) NOT NULL, action_date DATETIME NOT NULL, INDEX IDX_EDBFD5ECA76ED395 (user_id), INDEX IDX_EDBFD5ECA77FBEAF (blog_post_id), UNIQUE INDEX UNIQ_EDBFD5EC381CDA7C (old_post_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS old_post (id INT AUTO_INCREMENT NOT NULL, created_by_id INT NOT NULL, author_id INT NOT NULL, created_at DATETIME NOT NULL, published_at DATETIME DEFAULT NULL, titre VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_7217ED28B03A8386 (created_by_id), INDEX IDX_7217ED28F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS old_post_categorie (old_post_id INT NOT NULL, categorie_id INT NOT NULL, INDEX IDX_9E9BAB81381CDA7C (old_post_id), INDEX IDX_9E9BAB81BCF5E72D (categorie_id), PRIMARY KEY(old_post_id, categorie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS categorie (id INT AUTO_INCREMENT NOT NULL, categorie_parente_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, valid TINYINT(1) NOT NULL, deleted TINYINT(1) NOT NULL, INDEX IDX_497DD6345CBD743C (categorie_parente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
